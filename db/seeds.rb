...
#teksten
Text.update_by_key("new_idea", :description => "Deze tekst komt te staan op de 'maak een nieuw idee' pagina.", :allow_title => false, :allow_body => true, :allow_images => false, :key_title => "Nieuw Idee")
Text.update_by_key("new_solution", :description => "Deze tekst komt te staan op de 'maak een nieuwe oplossing' pagina.", :allow_title => false, :allow_body => true, :allow_images => false, :key_title => "Nieuwe oplossing")
Text.update_by_key("ideas_and_challenges", :description => "Deze tekst komt te staan op de 'programma' pagina wanneer er geen specifieke tekst is ingevuld voor de ideeën en challenges voor dit programma.", :allow_title => false, :allow_body => true, :allow_images => false, :key_title => "ideeën en uitdagingen")
Text.update_by_key("homepage", :description => "Deze tekst komt bovenaan de homepagina te staan.", :allow_title => true, :allow_body => true, :allow_images => false, :key_title => "homepagina")
...
#karma fases
Text.update_by_key("karma_col_1", :description => "Dit is de tekst voor het eerste karma niveau.", :body => "nog in te vullen", :allow_title => true, :allow_body => true, :allow_images => false, :key_title => "karma fase 1")
